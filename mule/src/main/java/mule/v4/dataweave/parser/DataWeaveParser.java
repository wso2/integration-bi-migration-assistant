...
public class DataWeaveParser extends Parser {
	...
	public static final int
		...
		RULE_objectField = 33, RULE_qualifiedIdentifier = 34, RULE_functionCall = 35, 
		RULE_typeExpression = 36;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"object", "objectField", "qualifiedIdentifier", "functionCall", "typeExpression"
		};
	}
	...
	public final QualifiedIdentifierContext qualifiedIdentifier() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_qualifiedIdentifier);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
