...
public class TestConverter {
    ...
    public void testSharedResourcesImportParsing() {
        deleteDirectoryIfExists("src/test/resources/mule/v3/sharedResources_output");
        testConvertingMultiMuleProjects(3, "src/test/resources/mule/v3/sharedResources",
                "src/test/resources/mule/v3/sharedResources_output", false, false);
    }
