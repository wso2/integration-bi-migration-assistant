...
public class DatabaseConnectorTest extends AbstractBlockTest {
    ...
    public void testBasicDbSelect() {
        testMule4ToBal("database-connector/basic_db_select.xml", "database-connector/basic_db_select.bal");
    }

    @Test
    public void testOracleDbSelect() {
        testMule4ToBal("database-connector/oracle_db_select.xml", "database-connector/oracle_db_select.bal");
    }
