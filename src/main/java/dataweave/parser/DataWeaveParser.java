...
public class DataWeaveParser extends Parser {
    ...
    public static final int
            ...
            RULE_expression = 10, RULE_primaryExpression = 11, RULE_builtInFunctionCall = 12,
    ...
    private static String[] makeRuleNames() {
        return new String[]{
                ...
                "expression", "primaryExpression", "builtInFunctionCall", "inlineLambda",
    ...
    public final ScriptContext script() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
                if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 21469186L) != 0)) {
                    {
                        setState(46);
                        body();
                    }
    ...
    public final GroupedContext grouped() throws RecognitionException {
        ...
        enterRule(_localctx, 40, RULE_grouped);
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(250);
