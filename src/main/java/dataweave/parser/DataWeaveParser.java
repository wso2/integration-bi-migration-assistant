...
public class DataWeaveParser extends Parser {
	...
	public static final int
		...
		T__9=10, T__10=11, T__11=12, T__12=13, VAR=14, FUNCTION=15, INPUT=16, 
		NAMESPACE=17, OUTPUT=18, DW=19, ASSIGN=20, ARROW=21, BOOLEAN=22, OPERATOR_EQUALITY=23, 
		OPERATOR_RELATIONAL=24, OPERATOR_MULTIPLICATIVE=25, OPERATOR_ADDITIVE=26, 
		OPERATOR_TYPE_COERCION=27, OPERATOR_RANGE=28, IDENTIFIER=29, INDEX_IDENTIFIER=30, 
		VALUE_IDENTIFIER=31, URL=32, MEDIA_TYPE=33, NUMBER=34, STRING=35, DATE=36, 
		REGEX=37, DOT=38, COLON=39, COMMA=40, LCURLY=41, RCURLY=42, LSQUARE=43, 
		RSQUARE=44, SEPARATOR=45, WS=46, NEWLINE=47, COMMENT=48, STAR=49, AT=50, 
		QUESTION=51;
	public static final int
		...
		RULE_unaryExpression = 24, RULE_primaryExpression = 25, RULE_grouped = 26, 
		RULE_selectorExpression = 27, RULE_literal = 28, RULE_array = 29, RULE_object = 30, 
		RULE_keyValue = 31, RULE_functionCall = 32, RULE_typeExpression = 33;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"unaryExpression", "primaryExpression", "grouped", "selectorExpression", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'map'", "'groupBy'", "'or'", "'and'", "'sizeOf'", "'upper'", "'lower'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, "VAR", "FUNCTION", "INPUT", "NAMESPACE", "OUTPUT", "DW", 
			"ASSIGN", "ARROW", "BOOLEAN", "OPERATOR_EQUALITY", "OPERATOR_RELATIONAL", 
	...
	public final ScriptContext script() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 11256576620546L) != 0)) {
				{
				setState(72);
				body();
				}
	...
	public static class ExpressionWrapperContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DataWeaveVisitor ) return ((DataWeaveVisitor<? extends T>)visitor).visitExpressionWrapper(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DefaultExpressionWrapperContext extends DefaultExpressionContext {
		...
		public DefaultExpressionWrapperContext(DefaultExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DataWeaveListener ) ((DataWeaveListener)listener).enterDefaultExpressionWrapper(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DataWeaveListener ) ((DataWeaveListener)listener).exitDefaultExpressionWrapper(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DataWeaveVisitor ) return ((DataWeaveVisitor<? extends T>)visitor).visitDefaultExpressionWrapper(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DefaultExpressionRestContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_defaultExpressionRest; }
	...
	public static class MapExpressionContext extends DefaultExpressionRestContext {
		...
		public MapExpressionContext(DefaultExpressionRestContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class DefaultExpressionEndContext extends DefaultExpressionRestContext {
		public DefaultExpressionEndContext(DefaultExpressionRestContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DataWeaveVisitor ) return ((DataWeaveVisitor<? extends T>)visitor).visitDefaultExpressionEnd(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class FilterExpressionContext extends DefaultExpressionRestContext {
		...
		public FilterExpressionContext(DefaultExpressionRestContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class GroupByExpressionContext extends DefaultExpressionRestContext {
		...
		public GroupByExpressionContext(DefaultExpressionRestContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public static class RelationalExpressionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DataWeaveVisitor ) return ((DataWeaveVisitor<? extends T>)visitor).visitRelationalExpression(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TypeCoercionExpressionContext extends ParserRuleContext {
		...
		public TerminalNode OPERATOR_TYPE_COERCION() { return getToken(DataWeaveParser.OPERATOR_TYPE_COERCION, 0); }
	...
	private PrimaryExpressionContext primaryExpression(int _p) throws RecognitionException {
		...
		int _startState = 50;
		enterRecursionRule(_localctx, 50, RULE_primaryExpression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final SelectorExpressionContext selectorExpression() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_selectorExpression);
		try {
			setState(310);
			_errHandler.sync(this);
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			setState(312);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 257702232064L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static class MultiKeyValueObjectContext extends ObjectContext {
		...
		public MultiKeyValueObjectContext(ObjectContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DataWeaveVisitor ) return ((DataWeaveVisitor<? extends T>)visitor).visitMultiKeyValueObject(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class SingleKeyValueObjectContext extends ObjectContext {
		...
		public SingleKeyValueObjectContext(ObjectContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DataWeaveVisitor ) return ((DataWeaveVisitor<? extends T>)visitor).visitSingleKeyValueObject(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TypeExpressionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DataWeaveVisitor ) return ((DataWeaveVisitor<? extends T>)visitor).visitTypeExpression(this);
			else return visitor.visitChildren(this);
		}
	}
