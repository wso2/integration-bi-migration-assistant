...
function activityExtension_12(xml input, map<xml> context) returns xml {
    xml var0 = checkpanic xslt:transform(input, transformXSLT(xml `<?xml version="1.0" encoding="UTF-8"?>
...
function activityExtension_13(xml input, map<xml> context) returns xml {
    xml var0 = checkpanic xslt:transform(input, transformXSLT(xml `<?xml version="1.0" encoding="UTF-8"?>
...
function activityExtension_14(xml input, map<xml> context) returns xml {
    xml var0 = checkpanic xslt:transform(input, transformXSLT(xml `<?xml version="1.0" encoding="UTF-8"?>
...
function process_creditapp_module_ExperianScore(xml input) returns xml {
    ...
    worker start_worker {
        xml result0 = receiveEvent_10(input, context);
        result0 -> StartToSendHTTPRequest;
    }
    worker ParseJSONToEnd {
        xml result0 = <- activityExtension_14_worker;
        result0 -> activityExtension_11_worker;
    }
    worker RenderJSONToSendHTTPRequest {
        xml result0 = <- activityExtension_13_worker;
        result0 -> activityExtension_12_worker;
    }
    worker SendHTTPRequestToEnd {
        xml result0 = <- activityExtension_12_worker;
        result0 -> activityExtension_14_worker;
    }
    worker StartToSendHTTPRequest {
        xml result0 = <- start_worker;
        result0 -> activityExtension_13_worker;
    }
    ...
    worker activityExtension_12_worker {
        xml input0 = <- RenderJSONToSendHTTPRequest;
        xml combinedInput = input0;
        xml output = activityExtension_12(combinedInput, context);
        output -> SendHTTPRequestToEnd;
    }
    worker activityExtension_13_worker {
        xml input0 = <- StartToSendHTTPRequest;
        xml combinedInput = input0;
        xml output = activityExtension_13(combinedInput, context);
        output -> RenderJSONToSendHTTPRequest;
    }
    worker activityExtension_14_worker {
        xml input0 = <- SendHTTPRequestToEnd;
        xml combinedInput = input0;
        xml output = activityExtension_14(combinedInput, context);
...
function receiveEvent_10(xml input, map<xml> context) returns xml {
    return input;
}
