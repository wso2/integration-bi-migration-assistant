...
public class XmlToModelTests {
    ...
    // private static final ProjectContext projectContext = new ProjectContext(new ProjectConversionContext(true, false, List.of()));
    ...
    //             XmlToTibcoModelParser.parseHTTPSharedResource(new ResourceContext(projectContext, "test"), "test", TestUtils.stringToElement(xmlText))
    //                     .orElseThrow();
    ...
    //     InlineActivity actual = XmlToTibcoModelParser.parseInlineActivity(processContext, element);
