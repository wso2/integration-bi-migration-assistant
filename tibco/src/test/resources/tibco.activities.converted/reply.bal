function reply(map<xml> context) returns xml | error {
    ...
    xml var1 = check xslt:transform(var0, xml`<?xml version="1.0"
        ...
        test="$Value/root/field"><tns2:Field><xsl:value-of select="$Value/root/field"/></tns2:Field></tns2:Response></item></tns1:postResponse></xsl:template></xsl:stylesheet>`, context);
    return var1;
}
